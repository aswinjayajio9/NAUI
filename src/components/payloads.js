...
export const materialDetailsDataPayload = {
    "Tenant": 6760,
    "Query": "SELECT ([Version].[Version Name] * [o9NetworkAggregation Network Plan Type].[o9NetworkAggregation Network Plan Type] * [Location].[Location] * [Item].[Item]) ON ROW, ({Measure.[Include Material Node], Measure.[Include Material Node Override], Measure.[Include Material Node Final], Measure.[Applied Material ABDM Rule]}) ON COLUMN;",
    "ExecutionContext": "Kibo Debugging Workspace",
    "EnableMultipleResults": true
}

export const resourceRulesPayload = {
    "Tenant": 6760,
    "Query": "SELECT ([Version].[Version Name] * [Data Object].[Data Object] * [DM Rule].[Rule]) ON ROW, ({Measure.[Network Aggregation Resource], Measure.[Network Aggregation Resource Type], Measure.[Network Aggregation Location], Measure.[Network Aggregation Location Region], Measure.[Network Aggregation Location Type], Measure.[Network Aggregation Include Resource Node]}) ON COLUMN;",
    "ExecutionContext": "Kibo Debugging Workspace",
    "EnableMultipleResults": true
}

export const resourceDetailsPayload = {
    "Tenant": 6760,
    "Query": "SELECT ([Version].[Version Name] * [o9NetworkAggregation Network Plan Type].[o9NetworkAggregation Network Plan Type] * [Location].[Location] * [Resource].[Resource]) ON ROW, ({Measure.[Include Resource Node], Measure.[Include Resource Node Override], Measure.[Include Resource Node Final], Measure.[Aggregation Simultaneous Resource], Measure.[Applied Resource ABDM Rule]}) ON COLUMN;",
    "ExecutionContext": "Kibo Debugging Workspace",
    "EnableMultipleResults": true
}
