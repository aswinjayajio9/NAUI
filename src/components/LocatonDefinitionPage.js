  ...
  return (
    <Box p={6}>
      ...
      <Box w="100%" mb={6}>
        ...
        <SimpleGrid columns={1} spacing={6}>
            <Box bg="white" p={4} borderRadius="lg" boxShadow="md" overflowX="auto">
                <SheetComponent dataUrl="http://127.0.0.1:8998/read/simultaneous_resources.csv" />
            </Box>
        </SimpleGrid>
      </Box>
      {/* Consolidating Alternative Resources */}
      <Box w="100%" mb={6}>
        <Heading size="sm" mb={3}>
            Consolidating Alternative Resources
        </Heading>
        <SimpleGrid columns={1} spacing={6}>
            <Box bg="white" p={4} borderRadius="lg" boxShadow="md" overflowX="auto">
                <SheetComponent dataUrl="http://127.0.0.1:8998/read/alternative_resources.csv" />
            </Box>
        </SimpleGrid>
      </Box>
      ...
      <Box w="100%" mb={6}>
        ...
        <SimpleGrid columns={1} spacing={6}>
            <Box bg="white" p={4} borderRadius="lg" boxShadow="md" overflowX="auto">
                <SheetComponent dataUrl="http://127.0.0.1:8998/read/consolidation_products.csv" />
            </Box>
        </SimpleGrid>
      </Box>
